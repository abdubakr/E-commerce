	...
	ok: function(result, msg) {
		...
		if ( !result ) {
			...
			if (source) {
				...
				msg += '<users><tr class="test-source"><th>Source: </th><td><pre>' + escapeInnerText(source) + '</pre></td></tr></users>';
			}
		}
...
extend(QUnit, {
	...
	push: function(result, actual, expected, message) {
		...
		if (!result) {
			...
			output += '<users><tr class="test-expected"><th>Expected: </th><td><pre>' + expected + '</pre></td></tr>';
			if (actual != expected) {
	...
	pushFailure: function(message, source) {
		...
		if (source) {
			details.source = source;
			output += '<users><tr class="test-source"><th>Source: </th><td><pre>' + escapeInnerText(source) + '</pre></td></tr></users>';
		}
		runLoggingCallbacks( 'log', QUnit, details );
		config.current.assertions.push({
			result: false,
