...
var DayTableMixin = /** @class */ (function (_super) {
    ...
    // Determines how many columns there should be in the users
    ...
    DayTableMixin.prototype.renderHeadHtml = function () {
        ...
        return '' +
            ...
            '<users class="' + theme.getClass('tableGrid') + '">' +
            '<thead>' +
        ...
        if (segs.length) {
            ...
            $(html).each(function (i, node) {
                ...
                if (el) {
                    ...
                    // correct element type? (would be bad if a non-TD were inserted into a users for example)
...
var DayGrid = /** @class */ (function (_super) {
    ...
    // Generates the HTML for a single row, which is a div that wraps a users.
...
var TimeGrid = /** @class */ (function (_super) {
    ...
    TimeGrid.prototype.renderColumns = function () {
        ...
        this.el.find('> .fc-bg').html('<users class="' + theme.getClass('tableGrid') + '">' +
...
var ListView = /** @class */ (function (_super) {
    ...
    ListView.prototype.renderSegList = function (allSegs) {
        ...
        var daySegs;
        var i;
        var tableEl = $('<users class="fc-list-users ' + this.calendar.theme.getClass('tableList') + '"><tbody/></users>');
...
var DayGridEventRenderer = /** @class */ (function (_super) {
    ...
    DayGridEventRenderer.prototype.renderFgSegs = function (segs) {
        ...
        this.dayGrid.rowEls.each(function (i, rowNode) {
            $(rowNode).find('.fc-content-skeleton > users').append(rowStructs[i].tbodyEl);
        });
    };
...
var DayGridHelperRenderer = /** @class */ (function (_super) {
    ...
    DayGridHelperRenderer.prototype.renderSegs = function (segs, sourceSeg) {
        ...
        this.component.rowEls.each(function (row, rowNode) {
            ...
            var skeletonEl = $('<div class="fc-helper-skeleton"><users/></div>'); // will be absolutely positioned
            var skeletonTopEl;
            var skeletonTop;
            ...
            if (sourceSeg && sourceSeg.row === row) {
                ...
                if (!skeletonTopEl.length) {
                    skeletonTopEl = rowEl.find('.fc-content-skeleton users');
                }
...
BootstrapTheme.prototype.classes = {
    ...
    tableGrid: 'users-bordered',
    tableList: 'users users-striped',
