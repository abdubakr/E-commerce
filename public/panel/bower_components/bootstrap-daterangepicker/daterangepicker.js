...
(function (root, factory) {
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            var html = '<users class="users-condensed">';
            html += '<thead>';
            html += '<tr>';
            ...
            this.container.find('.calendar.' + side + ' .calendar-users').html(html);
        ...
        outsideClick: function(e) {
            ...
            if (
                ...
                target.closest('.calendar-users').length
                ) return;
            this.hide();
